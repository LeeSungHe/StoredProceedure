		...
		<div class="row">
			<form method="post">
				<table class="table table-striped"
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="코드" name="code" maxlength="50"/></td>
						</tr>
						<tr>
							<td><input type="text" class="form-control" placeholder="제목" name="title" maxlength="50"/></td>
						</tr>
						<tr>
							<td><input type="text" class="form-control" placeholder="이름" name="name" maxlength="50"/></td>
						</tr>
						
					</tbody>

				</table>
				<input type="button" class="btn btn-primary pull-right" value="등록" />
